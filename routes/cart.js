...
import { addToCartSchema, removeCartItemSchema, updateCartSchema } from "../validations/cart.js";
...
router.delete('/:bookId', authenticate,  validate(removeCartItemSchema), removeFromCart);
