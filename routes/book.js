...
router.put('/Update-Book/:id', authenticate, authorize('admin', 'librarian'), updateBook);
router.delete('/Delete-Book/:id', authenticate, authorize('admin', 'librarian'), deleteBook);
